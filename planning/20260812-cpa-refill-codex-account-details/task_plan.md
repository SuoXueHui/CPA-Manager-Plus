...
3. [in_progress] Controller TDD：Codex-only reconciliation/list/overview，完整账号与 usage 汇总 DTO。
4. [pending] Manager TDD：账号 usage 聚合代理/合并，简体中文状态和值映射和账号表格。
5. [pending] 全量测试、构建、review 和内嵌前端同步。
